...
#include <glad/gl.h>
    ...
    // SFML requires at a bare minimum OpenGL ES 2.0 capability
    ...
    // Core since 2.0 - EXT_blend_subtract
    ...
    // Core since 2.0 - EXT_blend_func_separate
    ...
    // Core since 2.0 - EXT_texture_npot
    #define GLEXT_texture_non_power_of_two            true

    // Core since 2.0 - EXT_framebuffer_object
    ...
    #define GLEXT_GL_FRAMEBUFFER_BINDING              GL_DRAW_FRAMEBUFFER_BINDING
    ...
    #define GLEXT_GL_CURRENT_PROGRAM                  GL_CURRENT_PROGRAM
    #define GLEXT_GL_PROGRAM                          GL_PROGRAM
    #define GLEXT_GL_COMPILE_STATUS            GL_COMPILE_STATUS
    #define GLEXT_GL_LINK_STATUS               GL_LINK_STATUS
